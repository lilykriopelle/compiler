 ...
 * 
 * We will represent operands as constants, temporary variables, and
 * program variables.  For temporary variables and program variables
 * we will search in the instruction list decoration for the
 * reference.
 * 
 * */
